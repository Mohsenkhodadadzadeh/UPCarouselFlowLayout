...
open class UPCarouselFlowLayout: UICollectionViewFlowLayout {
    ...
    @IBInspectable open var sideItemColor: UIColor = #colorLiteral(red: 0.501960814, green: 0.501960814, blue: 0.501960814, alpha: 1)
    ...
    fileprivate func updateLayout() {
        ...
        var xInset = ((collectionSize.width - self.itemSize.width) / 2) - 75
        xInset = xInset < 15 ? 15 : xInset
